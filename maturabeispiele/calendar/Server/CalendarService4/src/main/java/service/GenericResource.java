...
import repository.CalendarFacade;
...
public class GenericResource {
    ...
    public void create(CalendarOwner entity) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("{id}")
    public void edit(@PathParam("id") long id, CalendarOwner a) {
        CalendarOwner app = fromDto(a);
        app.setId(id);
        this.af.edit(app);
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public CalendarOwner getAppointment(@PathParam("id") long id) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public List<CalendarOwner> getAppOfCal(@PathParam("id") long id){
    ...
    private CalendarOwner toDto(Appointment a) {
        return new CalendarOwner(a.getId(),
                a.getDescription(),
    ...
    private Appointment fromDto(CalendarOwner a) {
